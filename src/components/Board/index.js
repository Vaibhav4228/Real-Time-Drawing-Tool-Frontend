...
const Board = () => {
    ...
    const historyPointer = useRef(0) //it will take a history when we do undo redo operations
    ...
    useEffect(() => {
        ...
        if (actionMenuItem === MENU_ITEMS.DOWNLOAD) {
            const URL = canvas.toDataURL()//for download the file we use toDataURL but this is very large file for this we are use anchor tag
            const anchor = document.createElement('a')
            anchor.href = URL
            anchor.download = 'V sketch.jpg'
            anchor.click()
